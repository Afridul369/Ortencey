  ...
  return (
    ...
    <div className="bg-AboutBG bg-no-repeat bg-cover bg-center bg-DarkGrey pt-40 pb-40 mb-14">
        <div className="text-center">
            <Text as='h1' text='Service Details' className='text-[46px] font-bold font-Nunito text-white'/>
            <Flex className={'justify-center items-center gap-x-2'}>
                ...
                <Text as='p' text=' Service Details' className='text-base font-Dm text-white'/>
            </Flex>
        </div>
    </div>
    </>
